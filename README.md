...
A investigação foi dividida em três etapas lógicas:
...
<p align="center"> <img src="resultados/mapas/mapa_distribuicao_casos.png" width="800"> </p>
...
<p align="center"> <img src="resultados/graficos/top20_taxa_incidencia.png" width="800"> </p>
...
Para tornar essa lógica ainda mais clara, a análise foi focada em indicadores diretos de renda:

<table align="center"> <tr> <td align="center"><strong>Taxa de Incidência vs. IDHM (Geral)</strong></td> <td align="center"><strong>Taxa de Incidência vs. PIB (Geral)</strong></td> </tr> <tr> <td><img src="resultados/graficos/dispersao_zika_idhm.png" width="450"></td> <td><img src="resultados/graficos/dispersao_zika_pib.png" width="450"></td> </tr> <tr> <td align="center"><strong>Análise Focada: Taxa vs. IDHM Renda (2010)</strong></td> <td align="center"><strong>Análise Focada: Taxa vs. PIB per capita (2015)</strong></td> </tr> <tr> <td><img src="resultados/graficos/dispersao_zika_idhm_renda.png" width="450"></td> <td><img src="resultados/graficos/dispersao_zika_pib.jpg" width="450"></td> </tr> </table>
...
<p align="center"> <img src="resultados/graficos/heatmap_correlacao_zika.png" width="700"> </p>

🚀 Como Replicar a Análise
<details> <summary>Clique para expandir as instruções de instalação e execução</summary>

1. Pré-requisitos
O projeto foi desenvolvido em Python 3.10+. Para instalar as dependências principais (presentes no script 01_coleta_dados.py), execute:
...
<details> <summary>Clique para expandir a estrutura de pastas</summary>
